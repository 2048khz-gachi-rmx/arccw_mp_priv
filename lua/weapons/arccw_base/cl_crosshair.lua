...
function SWEP:DoDrawCrosshair(x, y)
	...
	clr:Set(GetConVar("arccw_crosshair_clr_r"):GetInt(),
	...
	outlineClr:Set(GetConVar("arccw_crosshair_outline_r"):GetInt(),
